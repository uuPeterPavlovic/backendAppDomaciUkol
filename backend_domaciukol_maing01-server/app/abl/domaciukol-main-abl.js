...
const Errors = require("../api/errors/domaciukol-main-error.js");
...
const logger = LoggerFactory.get("DomaciukolMainAbl");

class DomaciukolMainAbl {
  constructor() {
  ...
  async init(uri, dtoIn, session) {
    ...
    if (dtoIn.uuBtLocationUri) {
      ...
      const createAwscDtoIn = {
        name: "BackendDomaciukol",
        typeCode: "backend-domaciukol-maing01",
        location: location,
...
module.exports = new DomaciukolMainAbl();
